...
router.get("/", (req, res) =>
  res.json([
    ...
    },
    {
      ...
      acertijo:
        "¿Cuál de las siguientes películas fue dirigida por Steven Spielberg?",
      opciones: {
        A: "Jurassic Park",
        B: "Titanic",
        C: "Star Wars",
    ...
    },
    {
      ...
      acertijo:
        "¿Cuál de los siguientes elementos químicos tiene el símbolo 'H'?",
      opciones: {
        A: "Helio",
        B: "Oxígeno",
        C: "Hidrógeno",
    ...
    },
    {
      _id: { $oid: "1" },
      acertijo:
        "¿Qué filósofo griego es conocido por sus diálogos y su teoría de las Ideas?",
      opciones: {
        A: "Sócrates",
        B: "Aristóteles",
        C: "Platón",
    ...
    },
    {
      _id: { $oid: "2" },
      acertijo:
        "¿En qué año Albert Einstein publicó su teoría de la relatividad especial?",
      opciones: {
        A: "1905",
        B: "1921",
        C: "1935",
    ...
    },
    {
      _id: { $oid: "7" },
      acertijo:
        "¿Qué pintor neerlandés es conocido por sus autorretratos y 'La noche estrellada'?",
      opciones: {
        A: "Vermeer",
        B: "Mondrian",
        C: "Van Gogh",
    ...
    },
    {
      _id: { $oid: "21" },
      acertijo:
        "¿Cuál es el instrumento musical conocido como 'el rey de los instrumentos'?",
      opciones: {
        A: "Violín",
        B: "Piano",
        C: "Flauta",
    ...
    },
    {
      _id: { $oid: "24" },
      acertijo:
        "¿Cuál es el proceso de eliminación de sales disueltas en agua para obtener agua potable?",
      opciones: {
        A: "Desalación",
        B: "Ebullición",
        C: "Destilación",
